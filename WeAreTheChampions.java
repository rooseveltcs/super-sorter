...
public class WeAreTheChampions implements ActionListener{// A clone class that returns a fileName
   private GUI gui;
   
   public WeAreTheChampions(GUI gui){// A constructor
      this.gui = gui;
   }
