...
public class EyeoftheTiger implements ActionListener{// A clone class that returns a fileName
   private GUI gui;
   
   public EyeoftheTiger(GUI gui){// A constructor
      this.gui = gui;
   }
   
   public void actionPerformed(ActionEvent e){// Returns a fileName
      String fileName = "EyeoftheTiger";
