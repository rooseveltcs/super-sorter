...
public class HitchHikersGuide implements ActionListener{// A clone class that returns a fileName
   private GUI gui;
   
   public HitchHikersGuide(GUI gui){// A constructor
      this.gui = gui;
   }
   
   public void actionPerformed(ActionEvent e){// Return a fileName
      String fileName = "HitchHikersGuide";
